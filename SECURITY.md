...
- **Initial triage and impact assessment** within 7 days.
- **Fix or mitigation timeline** communicated within 14 days.
- **Public disclosure** coordinated with you, typically 30 to 90 days after a fix ships in the default branch.
...
- Self-hosted misconfiguration where the operator has bypassed the documented setup (for example, committed `.env.local` to a public repo, used a hand-typed `hmac_secret` shorter than the receiver enforces).
