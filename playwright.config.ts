...
// ADMIN_EMAIL, DATABASE_URL) that CI and fresh clones don't have. CI always runs against a
...
export default defineConfig({
  ...
  projects: [
    ...
    {
      // The operator triages the inbox from a phone as often as a laptop; the ecosystem UI/UX
      // standard (witus docs/shared-ui-ux-dx.md) is mobile-first at 360px. Same specs, small
      // viewport.
      name: "mobile",
      use: {
        ...devices["Pixel 7"],
