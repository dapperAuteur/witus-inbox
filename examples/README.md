...
- **Stable across publishers' analogues.** If three products have a "newsletter signup" form, all three use `form_type: "newsletter-signup"`, which lets the receiver group cross-product analytics.
