...
This repo's queue is one of the reference implementations (alongside witus + bam-landing-page). Full rule with rationale: `/Users/bam/Code_NOiCloud/ai-builds/gemini/witus/CLAUDE.md` §"Operator-task rule".
